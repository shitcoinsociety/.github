...
We are developing the [Shitcoin Society platform](https://github.com/shitcoinsociety/platform), an open-source crypto MLM project with built-in trading engine. Earn daily dividends by holding our Revenue Share Token ($RST), available for presale from [select members](https://github.com/buhrmi) of the Shitcoin Society.
